...
module.exports = class VideoHandler {
    ...
    constructor(service) {
        ...
        const { credentials, ...storage } = config.storage;
        this.storage = new Storage(credentials, storage);
    ...
    putVideo(req, res) {
        ...
        this.storage.uploadTo(videoPath.toString(), req.headers['content-type'], req)
            .then(() => {
                res.sendStatus(201);
                return;
            })
